...
import CharacterProgress from "app/components/CharacterProgress/CharacterProgress";
            ...
            <div className="CharacterMenu">
                <header>
                    <div className="CharacterMenu-portrait-group">
                        ...
                        <CharacterProgress experience={character.experience} level={character.level}/>
                    </div>
