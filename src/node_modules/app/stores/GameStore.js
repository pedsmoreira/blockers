...
class GameStore extends Store {
    ...
    @action.bound cast(index: number): void {
        if (!this.playing) return;

        const spell: Spell = this.character.spells[index];
    ...
    @action setPiece(piece: Piece | null = null, position: Position | null = null) {
