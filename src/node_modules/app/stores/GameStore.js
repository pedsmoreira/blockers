...
class GameStore extends Store {
     ...
     * Menu actions
     */
    @action.bound selectCharacter(characterClass: Function) {
        this.characterClass = characterClass;
    }

    @action.bound selectStage(stageClass: Function) {
    ...
    @action.bound newPiece(piece: Piece = null, piecePosition: Position | null = null): void {
        if (!this.playing) return;
    ...
    @action.bound decay(): boolean {
        return this.move(0, 1);
    }

    @action.bound addEffect(effect: Effect, duration = null): void {
